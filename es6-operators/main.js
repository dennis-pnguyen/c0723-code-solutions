...
console.log('value of config1:', config1, 'value of config2:', config2);
...
console.log('value of cfg1:', cfg1);
console.log('value of cfg2:', cfg2);
console.log('value of cfg3:', cfg3);
...
console.log('value of tern1:', tern1);
console.log('value of tern2:', tern2);
...
const oc2 = v2?.value;
const oc3 = v3?.value;
console.log('value of oc1:', oc1);
console.log('value of oc2:', oc2);
console.log('value of oc3:', oc3);
